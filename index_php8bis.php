...
$sql = null;
    ...
    $END_manq = 100-$END_PC;
?>
<div id='barre3_cl' class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: <?=$END_PC;?>%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">END</div>
<br>
<?php $conn = null; ?>